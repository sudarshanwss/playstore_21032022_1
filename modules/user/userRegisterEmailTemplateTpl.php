                      ...
                      <tr style="margin: 0;padding: 0;box-sizing: border-box;font-size: 14px;">
                        <td style="margin: 0;padding: 0 0 20px;">
                          <table width="100%" cellpadding="0" cellspacing="0" style="margin: 0;padding: 0;box-sizing: border-box;font-size: 14px;">
                            <tr style="margin: 0;padding: 0;box-sizing: border-box;font-size: 14px;">
                              <td style="margin: 0;padding: 0 0 20px;box-sizing: border-box;font-size: 14px;vertical-align: top;color: #000000">Account verification email</a>
                              </td>
                            </tr>
                            <tr>
                              <td style="margin: 0;padding: 0 0 20px; color: #000000">Hi, welcome to Starz Race Thanks for registering. You are sure to have a great time ahead.</td>
                            </tr>
                          </table>
                          <table width="100%" cellpadding="0" cellspacing="0" style="margin: 0;padding: 0;box-sizing: border-box;">
                            <tr style="margin: 0;padding: 0;">
                              <td style="margin: 0;padding: 0 0 20px; color: #000000">Please click the button below to verify your email.</td>
                            </tr>
                            <tr>
                              <td style="margin: 0;padding: 0 0 20px;"><a href="<?php echo $link ;?>"><img style="width:25%;" src="<?php echo getConfig('base_domain_path').getConfig('static_path_image')."/verify.png"?>" /><a href="<?php echo $link ;?>"></a></td>
                            </tr>
                            <tr>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              <td style="color: #000000;">Fun Run team</td>
                            </tr>
                            <tr>
                              <td style="margin: 0;padding: 20px 0 0 0; color: #000000;">Note: This mail is for verification purpose only. Kindly do not reply.</td>
                            </tr>
                          </table>
                        </td>
                      </tr>
