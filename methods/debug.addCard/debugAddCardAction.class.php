 ...
 * Date   : 06-02-2018
 * Desc   : This is a controller file for debugAddCard Action
 */
class debugAddCardAction extends baseAction{
	/**
   * @OA\Get(path="?methodName=debug.addCard", tags={"Debug"}, 
  ...
  public function execute()
  {
    ...
    $cardLib->updateUserCard($userCard['user_card_id'], array("user_card_count" => $this->count));
